...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/kaldi_io-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13272&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/kaldi_io-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `kaldi_io` can be installed with:

```
conda install kaldi_io
```

It is possible to list all of the versions of `kaldi_io` available on your platform with:
